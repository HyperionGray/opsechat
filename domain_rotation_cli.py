...
def _format_datetime(value, fmt):
    """Format datetime values from state, tolerating strings from legacy configs."""
...
def get_manager():
    ...
    # Load persisted state and normalize legacy serialized values.
    manager.load_state({
