...
def get_manager():
    ...
    # Load persisted state in a backward-compatible way.
...
def _format_datetime(value, format_str: str, fallback: str = "unknown"):
    """Render datetime objects or ISO strings safely for CLI output."""
    if value is None:
        return fallback
