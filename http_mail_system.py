...
class HttpMailbox:
    ...
    def add_message(self, subject: str, body: str, sender_handle: str) -> str:
        ...
        Raises RuntimeError if mailbox has been destroyed.
        """
    ...
    def destroy(self) -> None:
        """Mark mailbox as destroyed and wipe all message contents."""
        with self.lock:
            self.destroyed = True
            for msg in self.messages:
                msg.overwrite()
...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        # destroyed and wipe contents under its lock to block in-flight writers.
        mailbox.destroy()
