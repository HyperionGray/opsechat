...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        Concurrency notes:
        - Remove mailbox from global store under `self._lock`.
        - Overwrite + clear message memory under per-mailbox lock.
        - Mark mailbox as destroyed so stale references reject writes.
        """
