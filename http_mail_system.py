...
class HttpMailbox:
    ...
    def __init__(self, address: str, read_key: str):
        ...
        self.destroyed_at: Optional[datetime.datetime] = None
...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        # Now that the mailbox is no longer globally reachable, scrub and
        # clear all message data under the mailbox lock.
        with mailbox.lock:
            mailbox.destroyed = True
            mailbox.destroyed_at = datetime.datetime.now()
