...
class HttpMailbox:
    ...
    def destroy(self) -> None:
        """Overwrite and clear all mailbox data, then prevent future writes."""
        with self.lock:
...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        # The mailbox object may still be held by stale references.
        # Destroying it marks it read-only for all future writes.
        mailbox.destroy()
