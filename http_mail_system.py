...
class HttpMailbox:
    ...
    def destroy(self) -> None:
        """Overwrite all messages and permanently disable this mailbox object."""
        with self.lock:
            if self.destroyed:
                return
...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        # overwrite and clear its messages, and mark it as destroyed so any
        # stale object reference cannot accept writes after deletion.
        mailbox.destroy()
        return True
