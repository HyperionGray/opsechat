...
class HttpMailbox:
    ...
    def add_message(self, subject: str, body: str, sender_handle: str) -> Optional[str]:
        """Add a message and return the new ID, or None if mailbox is destroyed."""
        with self.lock:
            if self.destroyed:
                return None
...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        This method marks a mailbox as destroyed and wipes messages under
        the mailbox lock so stale references cannot append new messages.
        """
