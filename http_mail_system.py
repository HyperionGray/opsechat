...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        This method marks the mailbox as destroyed while holding the mailbox
        lock so that any stale references cannot append messages after delete.
        """
        ...
        # destroyed, scrub message content, and clear under the mailbox lock.
        with mailbox.lock:
