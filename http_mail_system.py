...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        - We then destroy mailbox contents under the per-mailbox lock so
          stale references cannot continue accepting writes.
        """
        ...
        # Destroy data and block future writes through stale references.
        mailbox.destroy()
        return True
