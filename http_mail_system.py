...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        Security guarantees:
        - `HttpMailbox` has a dedicated lock used by all writers.
        - `add_message` checks mailbox `destroyed` state under that lock.
        """
        ...
        # This avoids races with concurrent send/add operations and ensures
        # future writes are denied even if another code path still has a ref.
        with mailbox.lock:
