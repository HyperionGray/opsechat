...
# Keep each mailbox bounded to prevent unbounded memory growth.
...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        - We then mark it destroyed, overwrite, and clear messages under the
          per-mailbox lock
        ...
        # Now that the mailbox is no longer globally reachable, safely mark
        # it as destroyed and scrub any in-memory message data.
        with mailbox.lock:
