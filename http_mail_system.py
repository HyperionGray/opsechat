...
class MailboxDestroyedError(RuntimeError):
    """Raised when writes are attempted on a destroyed mailbox."""
...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        with self._lock:
            ...
            # Lock mailbox while still under storage lock so stale references
            # cannot race a final add_message after deletion starts.
            with mailbox.lock:
