...
class HttpMailStorage:
    ...
    def delete_mailbox(self, address: str, read_key: str) -> bool:
        ...
        - We then destroy the mailbox under the per-mailbox lock to avoid
          races with concurrent send/add operations.
        """
        ...
        # Now that the mailbox is no longer globally reachable, destroy it.
        mailbox.destroy()
