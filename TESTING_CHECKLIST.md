...
```bash
cd /path/to/opsechat
pytest tests/test_chatroom.py tests/test_chat_ids.py tests/test_chat_endpoints.py tests/test_security_headers.py
```
**Expected**: Chat/security test modules pass
