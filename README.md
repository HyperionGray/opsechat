...
- **HTTP Mail (No SMTP/IMAP)** - Create mailbox address + read key and exchange short-lived messages over HTTP only (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
