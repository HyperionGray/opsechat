...
- **HTTP Mailboxes (No SMTP/IMAP)** - Create ephemeral in-memory mailboxes for direct HTTP message drop and retrieval (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
