...
- **HTTP Mailboxes (No SMTP/IMAP)** - Ephemeral inboxes over HTTP with per-mailbox secret read keys (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
- **Read-Key Rotation** - Revoke compromised mailbox read keys without destroying the mailbox
