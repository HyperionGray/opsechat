...
- **Automated Domain Purchasing** - Multi-registrar support (Porkbun and Namecheap) for cheap domain rotation (.xyz, .club, etc.) - see [Domain Registrar API](docs/setup/DOMAIN_REGISTRAR_API.md)
