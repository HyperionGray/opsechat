...
- **HTTP Mailboxes** - SMTP/IMAP-free mailbox flow with private `read_key` access control and secure destroy semantics (see [HTTP Mailboxes Guide](docs/user-guide/HTTP_MAIL.md))
