...
- **Configurable Chat Rate Limits** - Override chat endpoint limits with environment variables
...
Rate limit configuration: [Development Guide](docs/development/DEVELOPMENT.md#environment-variables)
