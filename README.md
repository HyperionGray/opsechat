...
- **Automated Domain Purchasing** - Multi-registrar support (Porkbun + Namecheap) for cheap domain rotation (.xyz, .club, etc.) - see [Domain Rotation Guide](docs/DOMAIN_ROTATION.md)
...
5. Configure a registrar for domain rotation (optional): Add API credentials and budget (see [Domain Rotation Guide](docs/DOMAIN_ROTATION.md))
