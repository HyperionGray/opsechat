...
- **Automated Domain Purchasing** - Multi-registrar integration (Porkbun + Namecheap) for domain rotation (.xyz, .club, etc.) - see [Domain Registrar API](docs/setup/DOMAIN_REGISTRAR_API.md)
