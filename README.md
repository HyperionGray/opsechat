...
Legal policy pages are available at `/terms`, `/privacy`, and `/aup` (plus path-prefixed variants for random-path deployments). Source documents live in [docs/legal](docs/legal/).
