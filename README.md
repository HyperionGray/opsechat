...
- **HTTP Mailboxes (default-deny)** - Lightweight mailbox addresses with private read keys, no SMTP/IMAP required (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
