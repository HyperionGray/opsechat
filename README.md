...
- **Automated Domain Purchasing** - Porkbun API integration for cheap domain rotation (.xyz, .club, etc.) with multi-provider fallback support - see [Domain Rotation Guide](docs/DOMAIN_ROTATION.md)
...
6. Optional maintenance: run `python domain_rotation_cli.py cleanup` to prune expired local domain entries
7. Compose and send emails: `http://yourservice.onion/{path}/email/compose`
8. View your inbox: `http://yourservice.onion/{path}/email`
