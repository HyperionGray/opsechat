...
- **Automated Domain Purchasing** - Porkbun and Namecheap API integration for cheap domain rotation (.xyz, .club, etc.) - see [Domain Registrar API](docs/setup/DOMAIN_REGISTRAR_API.md)
...
5. Configure a registrar API for domain rotation (optional): use Porkbun or Namecheap credentials plus budget settings (see [Domain API Setup Guide](docs/setup/DOMAIN_API_SETUP.md))
