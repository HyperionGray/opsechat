...
- **HTTP Mail (no SMTP/IMAP)** - Minimal mailbox messaging over HTTP with read-key access control, non-JS compose fallback, and secure destroy semantics (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
