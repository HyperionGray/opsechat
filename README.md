...
- **HTTP Mail (No SMTP/IMAP)** - Share mailbox address publicly and keep a private read key for default-deny inbox access (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
...
8. Optional HTTP-only mailbox flow: `http://yourservice.onion/{path}/mail`
