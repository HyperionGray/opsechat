...
- **HTTP Mail (No SMTP/IMAP)** - Ephemeral mailbox addresses with private read keys (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
...
8. Use HTTP Mail (SMTP-free): `http://yourservice.onion/{path}/mail`
