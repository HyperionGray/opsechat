...
- **Automated Domain Purchasing** - Multi-provider registrar support (Porkbun + Namecheap) for cheap domain rotation (.xyz, .club, etc.) - see [Domain Registrar API](docs/setup/DOMAIN_REGISTRAR_API.md)
