...
- **Automated Domain Purchasing** - Multi-registrar domain rotation with Porkbun + Namecheap support and provider fallback - see [Domain Registrar API](docs/setup/DOMAIN_REGISTRAR_API.md)
