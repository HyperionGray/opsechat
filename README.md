...
5. Configure domain registrar API for rotation (optional): Add Porkbun or Namecheap credentials and budget (see [Domain API Setup Guide](docs/setup/DOMAIN_API_SETUP.md))
