...
5. Configure a domain registrar API for domain rotation (optional): Add Porkbun or Namecheap credentials and budget (see [Domain API Setup Guide](docs/setup/DOMAIN_API_SETUP.md))
