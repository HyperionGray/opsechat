...
- **HTTP Mailboxes (No SMTP/IMAP)** - Create shareable mailbox addresses with private read keys; send and read over HTTP only (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
