...
- **HTTP Mailboxes (No SMTP/IMAP Required)** - Ephemeral inboxes with public send address + private read key
...
8. Use HTTP Mail for zero-setup messaging: `http://yourservice.onion/{path}/mail`
