...
- **HTTP Mail (SMTP/IMAP-free)** - Ephemeral mailbox-over-HTTP mode with read-key access control, pagination, and metadata API (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
