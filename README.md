...
- **HTTP Mailboxes** - SMTP/IMAP-free mailbox flow over HTTP with private read keys (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
- **Read Key Rotation** - Rotate mailbox read keys to invalidate old access keys without deleting messages
