...
- **Automated Domain Purchasing** - Multi-registrar API integration (Porkbun + Namecheap) for cheap domain rotation (.xyz, .club, etc.) - see [Domain Registrar API](docs/setup/DOMAIN_REGISTRAR_API.md)
