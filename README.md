...
- 💬 **Direct Messages** - Ephemeral single-use DMs for sharing room IDs (burn after first read, 1-min max lifetime)
...
- ✅ **Direct Messages** - Share room IDs securely (single-use, burns after first read, 1-minute max lifetime)
