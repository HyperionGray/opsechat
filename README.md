...
- **Automation-friendly Domain CLI** - Scriptable commands (`rotate-domain.py`) for search, pricing, list, and purchase flows - see [Domain Rotation CLI Guide](docs/user-guide/DOMAIN_ROTATION_CLI.md)
