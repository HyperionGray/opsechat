...
- **HTTP Mail (SMTP/IMAP-free)** - In-memory mailbox addresses with private read keys, message expiry, and read-key rotation (see [HTTP Mail Guide](docs/user-guide/HTTP_MAIL.md))
