...
- **HTTP Mailboxes (SMTP/IMAP-free)** - Create in-memory mailboxes over HTTP with secret read keys, pagination, and bulk purge support (see [HTTP Mail System Guide](docs/user-guide/HTTP_MAIL_SYSTEM.md))
