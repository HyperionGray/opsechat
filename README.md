...
- 💬 **Direct Messages** - Ephemeral single-read invites (burn-after-read, 1-min max lifetime)
...
- ✅ **Direct Messages** - Single-read room invites with immediate burn-after-read (1-minute max lifetime)
