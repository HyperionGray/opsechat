...
- ⚙️ **Configurable Chat Rate Limits** - Tune chat/DM limits via environment variables
...
Rate limit tuning details: [docs/user-guide/RATE_LIMIT_CONFIGURATION.md](docs/user-guide/RATE_LIMIT_CONFIGURATION.md)
