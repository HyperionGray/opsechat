...
- **Automated Domain Purchasing** - Multi-registrar support (Porkbun + Namecheap) for cheap domain rotation (.xyz, .club, etc.) - see [Domain Registrar API](docs/setup/DOMAIN_REGISTRAR_API.md)
...
5. Configure domain registrar API for rotation (optional): Add Porkbun and/or Namecheap credentials plus budget (see [Domain API Setup Guide](docs/setup/DOMAIN_API_SETUP.md))
