...
- **Automated Domain Purchasing** - Multi-provider integration (Porkbun + Namecheap) for cheap domain rotation (.xyz, .club, etc.) - see [Domain Registrar API](docs/setup/DOMAIN_REGISTRAR_API.md)
...
5. Configure domain registrar API for domain rotation (optional): Add Porkbun or Namecheap credentials and budget (see [Domain API Setup Guide](docs/setup/DOMAIN_API_SETUP.md))
