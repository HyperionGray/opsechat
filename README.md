...
- 💬 **Direct Messages** - Ephemeral single-read DMs for sharing room IDs (1-min max expiry)
...
- ✅ **Direct Messages** - Share room IDs securely (single-read, 1-minute max expiry)
