...
- 💬 **Direct Messages** - Ephemeral, single-view DMs for sharing room IDs (1-min expiry)
...
- ✅ **Direct Messages** - Share room IDs securely with burn-after-read semantics (1-minute max expiry)
