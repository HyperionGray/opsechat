...
def _secure_delete_dm(dm_id: str) -> None:
    """Overwrite sensitive DM fields before removing it from memory."""
...
def register_simple_chat_routes(app):
    ...
    def view_dm(dm_id):
        """View a direct message once, then securely delete it."""
        with dm_lock:
            ...
            # Burn-after-read semantics: first successful read consumes the DM.
            _secure_delete_dm(dm_id)
            return response
