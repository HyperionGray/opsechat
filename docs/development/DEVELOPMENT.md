...
### Maintenance Scripts
Maintenance and ad-hoc validation utilities live under `scripts/maintenance/`:

- **`scripts/maintenance/manual-test.py`** - Manual testing script for interactive testing
- **`scripts/maintenance/simple_test.py`** - Quick sanity checks
- **`scripts/maintenance/quick_import_test.py`** - Test Python imports
