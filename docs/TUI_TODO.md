...
- ✅ Per-user message rate limiting (12 messages / 30s)
- ✅ Structured server error events for rejected payloads/rate limits
- ✅ Live connected-user status updates in client footer
