...
- [HTTP Mail Status and Lifecycle Hardening](implementation/HTTP_MAIL_STATUS_AND_LIFECYCLE_HARDENING.md) - Authenticated mailbox status API and destruction hardening
