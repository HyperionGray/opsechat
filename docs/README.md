...
- [Privacy Policy](legal/PRIVACY_POLICY.md) - Privacy terms and data handling practices
...
- [Legal Policy Pages](implementation/LEGAL_POLICY_PAGES.md) - Web routes for terms/privacy/AUP
