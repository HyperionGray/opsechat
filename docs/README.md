...
Welcome to the OpSecChat documentation. All documentation has been organized into logical categories for easy navigation.
...
### Assessment & Reviews
Comprehensive assessments and code reviews of the project.

- [Alpha Readiness Assessment](assessment/ALPHA_READINESS_ASSESSMENT.md) - Detailed alpha requirements analysis
- [Alpha Assessment Summary](assessment/ALPHA_ASSESSMENT_SUMMARY.md) - Executive summary
- [Repository Status](assessment/REPOSITORY_STATUS.md) - Repository organization assessment
- [Security Assessment](assessment/SECURITY_ASSESSMENT.md) - Security analysis
- [Amazon Q Code Reviews](assessment/) - Multiple Amazon Q code review reports
- [CI/CD Reviews](assessment/) - CI/CD implementation reviews
...
- [Daily Progress 2026-03-06](assessment/DAILY_PROGRESS_2026-03-06.md) - Incremental plan and prioritized next steps
...
- [Domain Rotation](setup/DOMAIN_ROTATION.md) - Domain rotation system
- [Container Testing](setup/CONTAINER_TESTING.md) - Container testing guide
...
- [New Features](user-guide/NEW_FEATURES.md) - New features guide (v0.8.0)
- [Simple Chat Rooms](user-guide/SIMPLE_CHAT_ROOMS.md) - Web chat room documentation
- [TUI Quick Start](user-guide/TUI_QUICKSTART.md) - Terminal UI quick start
- [TUI README](user-guide/TUI_README.md) - Terminal UI full guide

### Development
Information for developers contributing to the project.

- [Development Guide](development/DEVELOPMENT.md) - Complete development setup and workflow
...
- [TODO Automation](development/TODO-automation.md) - Automation task tracking
...
- [Implementation Summary v0.8.0](implementation/IMPLEMENTATION_SUMMARY_v080.md) - v0.8.0 final summary
- [Simple Chat Implementation](implementation/IMPLEMENTATION_SUMMARY_SIMPLE_CHAT.md) - Simple chat implementation
- [Implementation Complete](implementation/IMPLEMENTATION_COMPLETE.md) - Feature completion status
- [Automation Consolidation](implementation/AUTOMATION_CONSOLIDATION.md) - Automation consolidation summary
- [TUI Implementation](implementation/TUI_IMPLEMENTATION_SUMMARY.md) - TUI implementation summary
...
- [Release Smoke Checklist](implementation/RELEASE_SMOKE_CHECKLIST.md) - Minimal pre-merge release validation steps
...
- Include date and author at top of document
- Use clear headers and sections
- Add table of contents for long documents
- Keep technical jargon to a minimum in user guides
