...
- [HTTP Mail Send Fallback and Destroy Guards](implementation/HTTP_MAIL_SEND_FALLBACK_AND_DESTROY_GUARDS.md) - No-JS compose flow and mailbox destruction hardening
