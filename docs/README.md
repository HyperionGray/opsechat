...
- [Privacy Policy](legal/PRIVACY_POLICY.md) - Privacy handling and retention model (draft)
...
- [Legal Policy Routes](implementation/LEGAL_POLICY_ROUTES.md) - `/terms`, `/privacy`, `/aup` implementation
