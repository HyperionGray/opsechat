...
- Replaced `static/jquery.js` placeholder with official jQuery v3.7.1 minified build
- Improved domain rotation state persistence via JSON-safe export/import helpers
