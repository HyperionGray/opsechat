...
- Domain rotation CLI persistence tests for config/state serialization

### Changed
- Improved repository structure and documentation organization
- Updated CI/CD compliance for better maintainability
- Domain rotation CLI now serializes and restores owned-domain timestamp fields
- Domain docs updated to reflect persistent CLI config behavior

### Security
- Continued jQuery 3.7.1 usage addressing CVE-2020-11023 and CVE-2020-11022
- Domain CLI config file is explicitly created with owner-only permissions (0600)
