...
- Legal policy web routes and rendering:
  - `/terms` (Terms of Service)
  - `/aup` (Acceptable Use Policy)
  - `/privacy` (Privacy Policy)
- New `docs/legal/PRIVACY_POLICY.md` draft document
- Test coverage for legal routes and safe markdown link handling (`tests/test_legal_routes.py`)

### Changed
- Improved repository structure and documentation organization
- Updated CI/CD compliance for better maintainability
- Chat index footer now links to policy routes

### Security
- Continued jQuery 3.7.1 usage addressing CVE-2020-11023 and CVE-2020-11022
- Legal markdown link rendering blocks non-http(s) scheme URLs (e.g. `javascript:`)
