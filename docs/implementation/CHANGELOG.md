...
- In-memory mock-server fallback implementations for email inbox and burner lifecycle (`tests/mock_server.py`)
- Focused fallback behavior tests (`tests/test_mock_server_fallback.py`)
...
### Removed
- Duplicate mock server artifact `tests/mock_server_refactored.py`
- Empty/placeholder workflow artifacts under `.github/.github/workflows/`
- Stray empty file `.github/d`
