...
- Domain timestamps are stored as ISO-8601 strings to keep state persistence JSON-safe
- Expired domains are automatically pruned when loading CLI state (or manually via `prune`)
