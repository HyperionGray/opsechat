...
Namecheap is now supported by `domain_manager.py` and `domain_rotation_cli.py`.
...
- Requires API whitelist configuration for your client IP
- Purchases require a default contact profile (registrant/admin/tech/billing fields)
- Better fit for users who already use Namecheap account tooling
