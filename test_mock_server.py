...
def _run_mock_server_check() -> bool:
    """Start mock server and verify the health endpoint responds."""
...
def test_mock_server():
    """Pytest entrypoint for mock server smoke test."""
    assert _run_mock_server_check()

if __name__ == '__main__':
    success = _run_mock_server_check()
