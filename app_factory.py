...
def create_app():
    ...
    def set_request_nonce():
        # Per-request nonce used by inline scripts rendered by Jinja templates.
    ...
    def add_security_headers(response):
        ...
        # - Strictly lock down scripts (inline scripts require per-request nonce)
        # - Allow existing inline styles while templates are incrementally modernized
