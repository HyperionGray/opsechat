...
def _inject_script_nonce(html: str, nonce: str) -> str:
    """Inject CSP nonce into script tags that don't already have one."""
...
def create_app():
    ...
    @app.before_request
    def set_csp_nonce():
        """Generate a per-request nonce for strict CSP script execution."""
        g.csp_nonce = secrets.token_urlsafe(16)

    @app.context_processor
    def inject_csp_nonce():
        """Expose a helper for templates that need the current CSP nonce."""
    ...
    def add_security_headers(response):
        ...
        # CSP: strict scripts via per-request nonce, compatible with existing inline styles.
        ...
        if nonce and response.mimetype == "text/html":
            ...
            response.set_data(_inject_script_nonce(html, nonce))
