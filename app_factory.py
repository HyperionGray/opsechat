...
def create_app():
    ...
    def add_security_headers(response):
        ...
        # Templates should avoid inline <script>/<style> so CSP remains strict.
    ...
    #
    # Operational note: keep container packaging aligned so rate_limiter.py is
    # available in images when rate limiting is expected to be enabled.
