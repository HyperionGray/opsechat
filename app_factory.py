...
def create_app():
    ...
    def add_security_headers(response):
        ...
        # CSP is intentionally strict; templates that require JavaScript should use
        # static JS files instead of inline script blocks.
    ...
    # Keep optional fallback for rate_limiter so minimal/runtime environments
    # can boot cleanly even when that module is intentionally omitted.
