...
✅ **Rate Limiting** - 12 messages per 30 seconds, per connected user  
...
- **Per-user rate limit**: 12 messages per 30 seconds
- **Max server history**: 500 messages (oldest messages overwritten and dropped)
