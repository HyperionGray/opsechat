...
- **mock_email_backend.py** - In-memory fallback email/burner backend used by mock_server
...
Burner email routes supported by the mock server:

- `GET/POST /{path}/email/burner`
