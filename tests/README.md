...
- **e2e.spec.js** - Backward-compatible entrypoint that loads all split `*.e2e.spec.js` suites
- **\*.e2e.spec.js** - Focused end-to-end suites (landing, chat, email, security, workflows)
