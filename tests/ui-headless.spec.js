...
test.describe("Headless UI Tests - Landing Page", () => {
  ...
  test("should have session cookie after visiting", async ({
    page,
    context,
  }) => {
    test.setTimeout(30000);
