...
# {"status":"healthy","service":"opsechat","active_rooms":0,"rate_limited_sessions":0,...}
```

The health payload now includes runtime checks (`checks`), uptime, and rate-limiter visibility to make deployment diagnostics easier.
